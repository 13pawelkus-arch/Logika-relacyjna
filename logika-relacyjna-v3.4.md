...
- **Do sprawdzenia:** czy wyniki §F1 (niezmienniczość tempa do v = 0,9; A/B = 1,507) stoją przy regule R-KĄT. Tamte przebiegi używały najmniejszej nadwyżki i miały dryf. Pełny sprinkling na GPU.
