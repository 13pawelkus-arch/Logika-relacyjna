...
- **Ø opisywane nie wprost, przez otoczenie — ten sam mechanizm w dwóch formalizmach (25.09, poprawka 114).**
  ...
  - **[L] Müller–Masanes, „Three-dimensionality of space and the quantum bit: an information-theoretic approach”, New J. Phys. 15, 053040 (2013), arXiv:1206.0630:** jeśli istnieją układy niosące **minimalną informację o kierunku**, oddziałujące parami, to wymiar przestrzeni **d = 3** i teoria kwantowa dwóch kubitów są wyznaczone jednoznacznie; przestrzeń stanów kubitu (kula Blocha) jest trójwymiarowa. **Filtr:** założenia zawierają gotową przestrzeń d-wymiarową i ciągłą ewolucję w czasie zewnętrznym — tego nie przejmujemy. Bierzemy wynik formalny: najmniejszy nośnik informacji i 3D wyznaczają się nawzajem. W ramie: foton = minimalne wzbudzenie = minimalna informacja [242–268], a 3D = triada + zapis. **[?]** czy „minimalna informacja o kierunku” u nich to nasz odczyt-link; do sprawdzenia na kartce, nie rachunkiem.
