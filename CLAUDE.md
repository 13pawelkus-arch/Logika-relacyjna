...
## Gdzie skończyliśmy (25.09.2026, rejestr do 129)
...
1a. **R1c (25.09): most R1b ↔ światło** — stożek stanów nośnika = stożek przyczynowy (det ρ = norma Minkowskiego), stany czyste = kierunki zerowe = foton, ∂B³ = sfera niebieska, Lorentz z komunikacji (Höhn–Müller 2016). Otwarte: tożsamość (nie tylko struktura) stożka stanów ze stożkiem przyczynowym punktu; translacje = przejście między czytającymi.
