...
- **Następne otwarte:** (1) pasmo bez dryfu tempa (E[Δ ln tref] = 0), potem ponownie podział budżetu; (2) dokończenie rachunku H₂: współczynniki typu I, typu II z dodatkowymi elementami i zależności; czarne dziury (po oczyszczeniu OTW z interpretacji). Pełna lista: „Dalej otwarte” w dokumencie.
