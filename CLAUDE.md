...
- **Nie używać słowa „obiekt”** (25.09): zakłada zawartość poza strukturą. Struktury bez różnicy relacji są ≡ (nierozróżnialne); pytanie „ten sam obiekt czy tylko ta sama struktura” jest zawsze źle postawione.
