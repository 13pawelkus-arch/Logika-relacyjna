...
**Dalej (pytania, niepoliczone):** ~~(a) czy warunki końca z poprawki 154 mają odpowiednik przy osobliwości~~ **(a) — rozstrzygnięte niżej (poprawka 160);** (b) promieniowanie Hawkinga i krzywa Page'a jako Ø → A — „zawarte, ale nieodczytywalne” (R3: reguła wysp / QES, czas Page'a).
