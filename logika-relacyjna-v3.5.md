...
| **przyspieszenie** | **A5d: Unruh, T_H = κ/2π, κ = lim(V·a)** | **brak w R1–R1f** | **weszło cicho** |
...
- **1. Promieniowanie Hawkinga = Ø od strony czytającego z zewnątrz [L][O].** Ten sam mechanizm co pkt 2 (Unruh): **próżnia ≡ Ø od strony czytającego stojącego poza brzegiem wygląda jak termiczna** — reguła językowa, nie „dziura coś wysyła”; w tabeli granic Ø: skok Ø → A = nowy odczyt. **T_H = κ/2π, κ = lim(V·a)**: V = stosunek tempa odczytu dalekiego do bliskiego (→ 0), a = przyspieszenie potrzebne do utrzymania się (→ ∞; *przyspieszenie weszło bez definicji — R1f-4, kandydat [?]*); **w ramie: T_H mówi, jak szybko stosunek tempa odczytu znika na brzegu** [472] — iloczyn skończony, choć każdy czynnik osobno nie. Rozkład termiczny = **zapis rozproszony** (R1a): pojedynczy odczyt nie niesie struktury.
