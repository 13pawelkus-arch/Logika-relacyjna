...
- **STAN ZESPOŁU — zestawienie po 166 (poprawka 167) [O].** Tabela z końca sesji 3 (zapis sesji 3, [91]; wtedy niewpisana), sprawdzona wobec pliku i uzupełniona o 166 i 168. Mapa, nie treść — treść w poprawkach podanych w nawiasach.
...
| **otwarte** | CKM; θ_QCD; y_e (skala relacji z tłem); grupa i 3 pokolenia warunkowo (156–158); ~~krytyczność λ policzona wprost na porządku~~ (168: w literaturze niepoliczona, zysk tylko przy samym ℓ ≡ Ø — nie podjęte); sztywność (A11d) |
