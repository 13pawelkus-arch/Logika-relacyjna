...
**Dalej (pytania, niepoliczone):** (a) czy warunki końca z poprawki 154 (λ = 0, β_λ = 0 — to samo Ø) mają odpowiednik przy osobliwości (pustynia od horyzontu [547]); (b) promieniowanie Hawkinga i krzywa Page'a jako Ø → A — „zawarte, ale nieodczytywalne” (R3: reguła wysp / QES, czas Page'a).
